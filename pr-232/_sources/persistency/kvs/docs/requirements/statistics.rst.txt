...
.. needpie:: Derivation Techniques Used In Testcases
   :labels: requirements-based, design-analysis, boundary-values, equivalence-classes, fuzz-testing, error-guessing, explorative-testing, fault-injection, interface-test
   :legend:

   type == 'testcase' and derivation_technique == 'requirements-based'
   ...
   type == 'testcase' and derivation_technique == 'fault-injection'
   type == 'testcase' and derivation_technique == 'interface-test'
