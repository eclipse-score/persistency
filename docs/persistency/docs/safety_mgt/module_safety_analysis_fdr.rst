...
.. list-table:: Safety Analysis Checklist
      ...
      * - 7
        - Are the templates for DFA and/or FMEA used? See :need:`doc__component_name_dfa` / :need:`doc__component_name_fmea` and also :ref:`process_requirements_safety_analysis`
        - [YES | NO ]
