...
@add_test_properties(
    partially_verifies=["comp_req__persistency__snapshot_creation"],
...
@add_test_properties(
    partially_verifies=["comp_req__persistency__snapshot_max_num"],
...
@add_test_properties(
    fully_verifies=["comp_req__persistency__snapshot_restore"],
    partially_verifies=[
