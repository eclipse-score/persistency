...
void SnapshotPaths::run(const std::string &input) const {
...

  {
    ...
    TRACING_INFO(
        ...
        std::make_pair(
            std::string("kvs_path"),
            kvs_path_res ? ("Ok(\"" + std::string(kvs_path_res.value()) + "\")")
                         : "Err(FileNotFound)"),
        std::make_pair(
...
Scenario::Ptr snapshot_count_max_count_scenario =
    std::make_unique<SnapshotMaxCount>();
Scenario::Ptr snapshot_count_restore_scenario =
    std::make_unique<SnapshotRestore>();
...
ScenarioGroup::Ptr snapshot_group{new ScenarioGroupImpl{
    "snapshots",
    {snapshot_count_scenario, snapshot_count_max_count_scenario,
     snapshot_count_restore_scenario, snapshot_count_paths_scenario},
    {}}};